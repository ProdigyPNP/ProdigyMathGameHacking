		...
		function redirectorCheck () {
			...
			fetch(`${redirectorDomain}/game.min.js?updated=${Date.now()}`)
				...
				.then(response => {
					...
					console.log("[PHEx] P-NP Domain: " + redirectorDomain);

					// <script src="https://code.prodigygame.com/code/2-0-0/game.min.js?v=2-0-0" onload="SW.Load.onGameLoad();" crossorigin="anonymous"></script>
